...
// Basic Types
let id:number = 5
let company:string = 'Emerald Coast Web Development'
let isPublished:boolean = true
let x:any = 'Hello'
const titleStyle:any = {color: 'black', fontSize: '20px'}
const paragraphStyle:any = {color: '#666', fontSize: '16px'}
...
const title:any = window.document.getElementById('title') // Selects the element with an ID of 'title'
const initialParagraph:any = window.document.getElementById('paragraph_text'); // Selects the element with an ID of 'age'
const output:any = window.document.querySelector('.output'); // Selects the element with a class of 'output'

// Sets a default value for unpublished message. This message will be displayed if the isPublished variable is false
const unpublishedMessage:string = 'This information is not public.'
